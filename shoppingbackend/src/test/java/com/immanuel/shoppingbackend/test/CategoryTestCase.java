...
public class CategoryTestCase {
	...
	public void testGetCategory() {
		...
		assertEquals("Succesfully fetched a single record from datavbase table", "Television", category.getName());
	}
	 ...
	 * 
	 * assertEquals("Getting list of categories from database",
